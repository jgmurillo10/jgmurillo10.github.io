(function() {
  ...
  var pageLoader   = document.getElementById('page-loader'); var pageLoaderLoader = document.getElementById('page-loader-loader');pageLoaderContent = document.getElementById('page-loader-content');

  var animationDuration = 800; pageLoaderContent.style.display = "none"
